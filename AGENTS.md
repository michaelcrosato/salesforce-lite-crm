...
| Claude | `C:\dev\salesforce-lite-crm-claude` | `claude/` branches | `SUMMARY.claude.md`, `BLOCKERS.claude.md` | registered at `claude/autonomy`; has local `app/dashboard/page.tsx` and `tsconfig.tsbuildinfo` changes as of `scripts/check-worktrees.ps1` on 2026-05-19 |
...
| Gemini | `C:\dev\salesforce-lite-crm-gemini` | `gemini/` branches | `SUMMARY.gemini.md`, `BLOCKERS.gemini.md` | registered at `gemini/autonomy`; has local `.github/workflows/ci.yml`, `next-env.d.ts`, `debug-analyst.ts`, and `tsconfig.tsbuildinfo` changes as of `scripts/check-worktrees.ps1` on 2026-05-19 |
